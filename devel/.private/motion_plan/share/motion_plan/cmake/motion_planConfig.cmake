...
if("TRUE" STREQUAL "TRUE")
  set(motion_plan_SOURCE_PREFIX /home/kmro/wr_ws/src/motion_plan)
  set(motion_plan_DEVEL_PREFIX /home/kmro/wr_ws/devel/.private/motion_plan)
  ...
  set(motion_plan_INSTALL_PREFIX /home/kmro/wr_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_plan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kmro/wr_ws/src/motion_plan/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kmro/wr_ws/devel/.private/motion_plan/lib;/home/kmro/wr_ws/devel/lib;/home/kmro/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
